...
<head>
    ...
    <title>REGISTRASI MOBILE LEGENDS</title>
...
<body>
    ...
    <div class="register-container">
        <h2>REGISTRASI TURNAMEN MOBILE LEGENDS</h2>
        <?php if ($gagal) {
            ?>
        ...
        <form class="register-form" method="POST">
            ...
            <label for="nick_name">Nickname Mobile Legends :</label>
            ...
            <a href="viewml.php" class="btn btn-primary">View</a>
